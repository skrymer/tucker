  ...
  <section class="flex flex-col gap-4">
    ...
    >
      ...
      <!-- Explains the Budget rather than flagging the Goal (ADR 0030): the
           ...
           the card that states it, and reads off the same summary that card does.
           A second endpoint here would let a failed goal read silence the one
           state that must not be quiet. -->
