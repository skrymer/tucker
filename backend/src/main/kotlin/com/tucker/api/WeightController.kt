 ...
 * latest reading. This is the figure a Goal is anchored on (ADR 0016), so the
 * Goal form reads it to preview the start weight and validate the target against
 * the same number the backend will judge them by.
 */
